...
public class NumberControl {
	...
	public static void main(String[] args) {
		...
		String PATH = "C:\\Users\\77hee\\eclipse-workspace\\8130\\src\\";
				...
				try {
					...
					if (!outputTextFile.exists()) {
						...
						if (reader.hasNext()) {
							...
							numberOfFloats= Integer.valueOf(reader.nextLine());
							...
							for (int i=0; i<numberOfFloats; i++) {
								...
								savedFloats[i]= Float.valueOf(reader.nextLine());
							}
						}else {
							reader.close();
							throw new InputMismatchException();
					...
					PrintWriter fileOutput = new PrintWriter(writer);
